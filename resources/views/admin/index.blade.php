                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ asset('build/images/plans/img-1.png') }}"
                                                                alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-13 my-1"><a
                                                                    href="{{ asset('/apps-ecommerce-plan-details') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ asset('build/images/plans/img-2.png') }}"
                                                                alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ asset('build/images/plans/img-3.png') }}"
                                                                alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-13 my-1"><a
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ asset('build/images/plans/img-4.png') }}"
                                                                alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-13 my-1"><a
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ asset('build/images/plans/img-5.png') }}"
                                                                alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div>
                                                            <h5 class="fs-13 my-1"><a
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-13 my-1"><a
                                                                    href="{{ asset('/apps-ecommerce-seller-details') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ asset('build/images/companies/img-8.png') }}"
                                                                alt="" class="avatar-sm p-2" />
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 my-1"><a
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ asset('build/images/companies/img-5.png') }}"
                                                                alt="" class="avatar-sm p-2" />
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-13 my-1"><a
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <a href="{{ asset('/apps-ecommerce-order-details') }}"
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                            <a href="{{ asset('/apps-ecommerce-plan-details') }}"
                                                class="bg-light rounded p-1">
                                                <img src="{{ asset('build/images/plans/img-8.png') }}" alt=""
                                                    class="img-fluid d-block" />
                                            </a>
                                            <a href="{{ asset('/apps-ecommerce-plan-details') }}"
                                                class="bg-light rounded p-1">
                                                <img src="{{ asset('build/images/plans/img-2.png') }}" alt=""
                                                    class="img-fluid d-block" />
                                            </a>
                                            <a href="{{ asset('/apps-ecommerce-plan-details') }}"
                                                class="bg-light rounded p-1">
                                                <img src="{{ asset('build/images/plans/img-10.png') }}" alt=""
                                                    class="img-fluid d-block" />
                                            </a>
                                        </div>

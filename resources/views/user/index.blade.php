        ...
        <div class="h-100">
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Best Selling Plans</h4>
                            <div class="flex-shrink-0">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ asset('build/images/plans/img-1.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-plan-details')}}" class="text-reset">Branded
                                                                T-Shirts</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ asset('build/images/plans/img-2.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a href="{{asset('/apps-ecommerce-plan-details')}}" class="text-reset">Bentwood
                                                                Chair</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ asset('build/images/plans/img-3.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-plan-details')}}" class="text-reset">Borosil Paper
                                                                Cup</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ asset('build/images/plans/img-4.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-plan-details')}}" class="text-reset">One Seater
                                                                Sofa</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ asset('build/images/plans/img-5.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-plan-details')}}" class="text-reset">Stillbird
                                                                Helmet</a></h5>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/companies/img-1.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-seller-details')}}" class="text-reset">iTest Factory</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/companies/img-2.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-seller-details')}}" class="text-reset">Digitech
                                                                Galaxy</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/companies/img-3.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-gow-1">
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-seller-details')}}" class="text-reset">Nesta
                                                                Technologies</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/companies/img-8.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-seller-details')}}" class="text-reset">Zoetic
                                                                Fashion</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/companies/img-5.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-13 my-1"><a href="{{asset('/apps-ecommerce-seller-details')}}" class="text-reset">Meta4Systems</a>
                                                        </h5>
                            ...
                            <div class="table-responsive table-card">
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="{{asset('/apps-ecommerce-order-details')}}" class="fw-medium link-primary">#VZ2112</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{asset('/apps-ecommerce-order-details')}}" class="fw-medium link-primary">#VZ2111</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{asset('/apps-ecommerce-order-details')}}" class="fw-medium link-primary">#VZ2109</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{asset('/apps-ecommerce-order-details')}}" class="fw-medium link-primary">#VZ2108</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{asset('/apps-ecommerce-order-details')}}" class="fw-medium link-primary">#VZ2107</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ asset('build/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
        ...
        <div class="layout-rightside">
            <div class="card h-100 rounded-0">
                <div class="card-body p-0">
                        ...
                        <div class="acitivity-timeline acitivity-main">
                            <div class="acitivity-item d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-muted mb-1">Plan noise evolve smartwatch </p>
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                        <a href="{{asset('/apps-ecommerce-plan-details')}}" class="bg-light rounded p-1">
                                            <img src="{{ asset('build/images/plans/img-8.png') }}" alt="" class="img-fluid d-block" />
                                        </a>
                                        <a href="{{asset('/apps-ecommerce-plan-details')}}" class="bg-light rounded p-1">
                                            <img src="{{ asset('build/images/plans/img-2.png') }}" alt="" class="img-fluid d-block" />
                                        </a>
                                        <a href="{{asset('/apps-ecommerce-plan-details')}}" class="bg-light rounded p-1">
                                            <img src="{{ asset('build/images/plans/img-10.png') }}" alt="" class="img-fluid d-block" />
                                        </a>
                                    </div>
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('build/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1 lh-base">Natasha Carey have liked the plans
                                    </h6>
                                    <p class="text-muted mb-1">Allow users to like plans in your
                                        WooCommerce store.</p>
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1 lh-base">Today offers by <a href="{{asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Digitech
                                            Galaxy</a></h6>
                                    <p class="text-muted mb-2">Offer is valid on orders of Rs.500 Or
                                        above for selected plans only.</p>
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1 lh-base">Favoried Plan</h6>
                                    <p class="text-muted mb-2">Esther James have favorited plan.
                                    </p>
                            ...
                            <div class="acitivity-item d-flex">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1 lh-base">Frank Hook Commented</h6>
                                    <p class="text-muted mb-2 fst-italic">" A plan that has
                                        reviews is more likable to be sold than a plan. "</p>
                    ...
                    <div class="p-3">
                        <h6 class="text-muted mb-3 text-uppercase">Plans Reviews</h6>
                        <!-- Swiper -->
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                                        <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
                                                            " Great plan and looks great, lots of
                                                            features. "</p>
                                    ...
                                    <div class="card border border-dashed shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-sm">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('build/images/companies/img-8.png') }}" alt="" height="30">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                                        <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
                                                            "Very beautiful plan and Very helpful
                                                            customer service."</p>
                                                        <div class="fs-11 align-middle text-warning">
                                                            <i class="ri-star-fill"></i>
                                                            <i class="ri-star-fill"></i>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                                        <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
                                                            " The plan is very beautiful. I like
                                                            it. "</p>
                                                        <div class="fs-11 align-middle text-warning">
                                                            <i class="ri-star-fill"></i>
                                                            <i class="ri-star-fill"></i>
                    ...
                    <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                        <div class="card-body">
                            <img src="{{ asset('build/images/giftbox.png') }}" alt="">
                            <div class="mt-4">
